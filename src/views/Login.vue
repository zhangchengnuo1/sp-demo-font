      ...
      <el-form :model="registerForm" :rules="registerRules" ref="registerForm" label-width="0px">
        <el-form-item label prop="userName">
          <el-row>
            ...
            <el-col :span="22">
              <el-input class="inps" placeholder="请输入用户名" v-model="registerForm.userName"></el-input>
            </el-col>
          </el-row>
        </el-form-item>
        <el-form-item label prop="passWord">
        ...
        <el-form-item label prop="passWordRe">
          <el-row>
            <el-col :span="2">
              <span class="el-icon-question"></span>
            </el-col>
            <el-col :span="22">
              <el-input
                ...
                type="password"
                placeholder="请输入密码"
                v-model="registerForm.passWordRe"
              ></el-input>
            </el-col>
          </el-row>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" round class="submitBtn" @click="registerSubmit">注册</el-button>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" round class="submitBtn" @click="returnLogin">返回</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
  ...
  data() {
    let validatePass = (rule, value, callback) => {
      ...
      if (value === "") {
        ...
        if (this.registerForm.passWordRe !== "") {
          this.$refs.registerForm.validateField("passWordRe");
        }
        callback();
      }
    };
      ...
      this.$axios.post(url, params).then(
        (res) => {
          if (res.data != "fail") {
            ...
            this.loginForm.passWord = res.data.pass;
          } else if(res.data == "fail"){
...
#login {
  ...
  background-size: 100%;
  background-image: url("../assets/backgroundgreentree.jpg");
  position: relative;
  #bgd {
    height: 100vh;
    width: 100vw;
